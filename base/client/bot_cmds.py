...
class BotCommands(object):
    ...
    def set_map(self, gamemap):
        ...
        # TODO: move private attribute assignment to __init__
        self._map = gamemap
            ...
            if "take" in base_command and username != "":
                ...
                if len(command) == 2:
                    try:
                        ...
                        # TODO check parameter types: float or int?
    ...
    def _add_teammate(self, username):
        if "_map" in dir(self) and "usernames" in dir(self._map):
            if username is not "" and \
                    username is not self._map.usernames[self._map.player_index] and \
