...
class GeneralsViewer(object):
    def __init__(self, name=None, move_event=None):
        ...
        self._name = name
        self._moveEvent = move_event  # self._moveEvent([source_x, source_y], [target_x, target_y])
    ...
    # TODO move all private attribute assignments to init
    ...
    def _handle_click(self, pos):
        if pos[1] < ABOVE_GRID_HEIGHT:
            ...
            self._receivedUpdate = True
        elif self._showGrid and ABOVE_GRID_HEIGHT < pos[1] < (
    ...
    def _draw_scores(self):
        ...
        for i, score in enumerate(self._scores):
            ...
            # TODO: simplify unneeded boolean check
            if score['dead'] is True:
